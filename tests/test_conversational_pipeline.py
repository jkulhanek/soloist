...
def test_conversational_pipeline(model):
    from pipelines import SoloistConversation, Conversation
    pipeline = transformers.pipeline('soloist-conversational', model=model)
    conversation_1 = SoloistConversation("I need a hotel.")
