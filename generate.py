...
from pipelines import SoloistConversation, get_context_from_conversation
import transformers
from tqdm import tqdm


def conversation_to_sample(conversation: SoloistConversation):
...
def sample_to_conversation(sample):
    conversation = SoloistConversation()
...
if __name__ == '__main__':
    ...
    pipeline = transformers.pipeline('soloist-conversational', device=0 if torch.cuda.is_available() else -1)
